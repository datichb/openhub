...
permission:
  bash:
    # Migrations base de données (additions sur la base developer-rw)
    "alembic*": allow
...
native_skills: [developer/dev-standards-security, developer/dev-standards-testing, developer/dev-standards-git, developer/dev-standards-migration, shared/rtk-usage, shared/living-docs-enrichment]
---
