...
3. Tester avec `oh deploy <cible>` puis `oh agent list`
...
- [ ] `oh deploy opencode` et `oh deploy --check opencode` passent sans erreur
- [ ] `oh deploy --diff opencode` ne montre aucune divergence inattendue
