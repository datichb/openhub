...
When `ONBOARDING.md` and `CONVENTIONS.md` already exist (enriched by other agents),
...
When `ONBOARDING.md` and `CONVENTIONS.md` already exist (generated by a previous onboarding
