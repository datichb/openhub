...
_section_2() {
  ...
  _h_sub "  --short/-s"                     "$(t help.status_short.desc)"
  _h_cmd "$(t help.remove.cmd)"             "$(t help.remove.desc)"
  _h_sub "  --clean/-c"                     "$(t help.remove_clean.desc)"
...
_section_3() {
  ...
  _h_sub "  --dev/-d"                           "$(t help.start_dev.desc)"
  _h_sub "  --dev/-d --label/-l <l>"            "$(t help.start_dev_label.desc)"
  _h_sub "  --dev/-d --assignee/-a <u>"         "$(t help.start_dev_assignee.desc)"
  _h_sub "  --onboard/-o"                       "$(t help.start_onboard.desc)"
  _h_sub "  --onboard/-o --refresh/-r"          "$(t help.start_onboard_refresh.desc)"
  _h_sub "  --parallel/-x"                      "$(t help.start_parallel.desc)"
...
_section_4() {
  ...
  _h_sub "  --type/-t <type>"         "$(t help.audit_type.desc)"
  _h_cmd "$(t help.conventions.cmd)"  "$(t help.conventions.desc)"
  _h_sub "  --force/-f"               "$(t help.conventions_force.desc)"
  _h_cmd "$(t help.review.cmd)"       "$(t help.review.desc)"
  _h_sub "  --branch/-b <branch>"     "$(t help.review_branch.desc)"
...
_section_5() {
  ...
  _h_sub "  --period/-d today|week|month"  "$(t help.metrics_period.desc)"
  _h_cmd "$(t help.optimize.cmd)"    "$(t help.optimize.desc)"
  _h_sub "  --project/-p <id>"       "$(t help.optimize_project.desc)"
  _h_sub "  --period/-d today|week|month"  "$(t help.optimize_period.desc)"
  _h_cmd "$(t help.yield.cmd)"       "$(t help.yield.desc)"
  _h_sub "  --project/-p <id>"       "$(t help.yield_project.desc)"
  _h_sub "  --period/-d today|week|month"  "$(t help.yield_period.desc)"
}

_section_6() {
  _h_section "$(t help.section.deployment)"
  _h_cmd "$(t help.deploy.cmd)"     "$(t help.deploy.desc)"
  _h_sub "  --check/-c"             "$(t help.deploy_check.desc)"
  _h_sub "  --diff/-D"              "$(t help.deploy_diff.desc)"
  _h_sub "  --provider/-P <p>"      "$(t help.deploy_provider.desc)"
  _h_cmd "$(t help.sync.cmd)"       "$(t help.sync.desc)"
  _h_sub "  --dry-run/-n"           "$(t help.sync_dryrun.desc)"
}
...
_section_8() {
  ...
  _h_sub "  --model/-m <model>"                 "$(t help.config_set_model.desc)"
  _h_sub "  --provider/-P <p>"                  "$(t help.config_set_provider.desc)"
  _h_sub "  --api-key/-k <key>"                 "$(t help.config_set_apikey.desc)"
  _h_sub "  --base-url/-u <url>"                "$(t help.config_set_baseurl.desc)"
  _h_sub "  --family-model/-F <family=model>"   "$(t help.config_set_family.desc)"
  _h_sub "  --agent-model/-a <agent=model>"     "$(t help.config_set_agent.desc)"
...
_section_10() {
  ...
  _h_sub "  --title/-T <title>"                       "$(t help.beads_create_title.desc)"
  _h_sub "  --label/-l <label>"                       "$(t help.beads_create_label.desc)"
  _h_sub "  --type/-t feature|fix|chore"              "$(t help.beads_create_type.desc)"
  _h_sub "  --desc/-d <desc>"                         "$(t help.beads_create_desc.desc)"
  _h_cmd "$(t help.beads_open.cmd)"                   "$(t help.beads_open.desc)"
  _h_cmd "$(t help.beads_sync.cmd)"                   "$(t help.beads_sync.desc)"
  _h_sub "  pull | push"                              "$(t help.beads_sync_dir.desc)"
  _h_sub "  --dry-run/-n"                             "$(t help.beads_sync_dry.desc)"
  ...
  _h_sub "  --watch/-w"                               "$(t help.beads_board_watch.desc)"
}
...
case "$FILTER" in
  ...
  "")
    ...
    _h_note "oc start -p MY-APP"
    _h_note "oc audit -p MY-APP --type/-t security"
    _h_note "oc deploy -p MY-APP"
    ;;
  *)
