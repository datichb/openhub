...
t() {
  ...
  if [ "$lang" = "fr" ]; then
    case "$key" in
      ...
      help.init.cmd)          printf '%s' "init [--name/-n <id>] [path]" ;;
      ...
      help.start_worktree.cmd) printf '%s' "start --worktree/-w [<branche>]" ;;
      ...
      help.start_agent.cmd) printf '%s' "start --agent/-A <nom>" ;;
      ...
      help.audit_type.cmd)    printf '%s' "audit [-p PROJECT_ID] --type/-t <type>" ;;
      ...
      help.sync_dryrun.cmd)   printf '%s' "sync --dry-run/-n" ;;
      ...
      help.config_unset.cmd)  printf '%s' "config unset -p <PROJECT_ID>" ;;
      ...
      # Services
      help.service_setup.cmd)   printf '%s' "service setup [nom] [-p PROJECT_ID]" ;;
      help.service_setup.desc)  printf '%s' "Configure un service interactivement (Figma, GitLab…)" ;;
      help.service_status.cmd)  printf '%s' "service status [nom] [-p PROJECT_ID]" ;;
      ...
      help.service_remove.cmd)  printf '%s' "service remove <nom> [-p PROJECT_ID]" ;;
      help.service_remove.desc) printf '%s' "Supprime la configuration d'un service" ;;
      help.service_deploy.cmd)  printf '%s' "service deploy <nom> [-p PROJECT_ID]" ;;
      help.service_deploy.desc) printf '%s' "Déploie le serveur MCP dans un projet" ;;
      # Beads
      help.beads_status.cmd)  printf '%s' "beads status [-p PROJECT_ID]" ;;
      help.beads_status.desc) printf '%s' "Vérifie si Beads est initialisé (tous si sans ID)" ;;
      help.beads_init.cmd)    printf '%s' "beads init -p <PROJECT_ID>" ;;
      help.beads_init.desc)   printf '%s' "Initialise .beads/ dans le projet" ;;
      help.beads_list.cmd)    printf '%s' "beads list -p <PROJECT_ID>" ;;
      help.beads_list.desc)   printf '%s' "Liste les tickets ouverts du projet" ;;
      help.beads_show.cmd)    printf '%s' "beads show -p <PROJECT_ID> --ticket/-i <ID>" ;;
      ...
      help.beads_tracker_status.cmd)  printf '%s' "beads tracker status -p <PROJECT_ID>" ;;
      help.beads_tracker_status.desc) printf '%s' "Affiche le statut de connexion au tracker" ;;
      help.beads_tracker_setup.cmd)   printf '%s' "beads tracker setup -p <PROJECT_ID>" ;;
      help.beads_tracker_setup.desc)  printf '%s' "Configure le tracker (interactif)" ;;
      help.beads_tracker_switch.cmd)  printf '%s' "beads tracker switch -p <PROJECT_ID>" ;;
      help.beads_tracker_switch.desc) printf '%s' "Change de provider de tracker" ;;
      help.beads_tracker_set_sync_mode.cmd)  printf '%s' "beads tracker set-sync-mode -p <PROJECT_ID> [mode]" ;;
     ...
     service.help.aliases)           printf '%s' "Aliases : oc figma → oc service figma, oc gitlab → oc service gitlab, oc gslides → oc service gslides" ;;
      ...
      start.config_title)       printf '%s' "Configuration" ;;
      start.config_provider)    printf '%s' "Provider" ;;
      start.config_model)       printf '%s' "Modèle" ;;
      start.config_language)    printf '%s' "Langue" ;;
      start.config_cache)       printf '%s' "Compaction" ;;
      start.config_cache_on)    printf '%s' "activée" ;;
      start.config_cache_off)   printf '%s' "désactivée" ;;
      start.config_cache_tokens) printf '%s' "tokens réservés" ;;
      start.config_agents_off)  printf '%s' "Agents off" ;;
...
t_en() {
  ...
  case "$key" in
    ...
    help.start_parallel.cmd) printf '%s' "start --parallel/-x" ;;
    help.start_parallel.desc) printf '%s' "Orchestrator-dev on ai-delegated tickets in an isolated worktree (auto multi-ticket mode). -x = e(x)ecute in parallel" ;;
    help.start_worktree.cmd) printf '%s' "start --worktree/-w [<branch>]" ;;
    ...
    help.review_branch.cmd) printf '%s' "review [-p PROJECT_ID] --branch/-b <branch>" ;;
    ...
    # Services
    help.service_setup.cmd)   printf '%s' "service setup [name] [-p PROJECT_ID]" ;;
    help.service_setup.desc)  printf '%s' "Configure a service interactively (Figma, GitLab…)" ;;
    help.service_status.cmd)  printf '%s' "service status [name] [-p PROJECT_ID]" ;;
    ...
    help.service_remove.cmd)  printf '%s' "service remove <name> [-p PROJECT_ID]" ;;
    help.service_remove.desc) printf '%s' "Remove a service configuration" ;;
    help.service_deploy.cmd)  printf '%s' "service deploy <name> [-p PROJECT_ID]" ;;
    help.service_deploy.desc) printf '%s' "Deploy the MCP server into a project" ;;
    # Beads
    help.beads_status.cmd)  printf '%s' "beads status [-p PROJECT_ID]" ;;
    help.beads_status.desc) printf '%s' "Check if Beads is initialized (all if no -p)" ;;
    help.beads_init.cmd)    printf '%s' "beads init -p <PROJECT_ID>" ;;
    ...
    help.beads_ui_start.cmd)  printf '%s' "beads ui start [-p PROJECT_ID] [--port N]" ;;
    ...
    start.config_title)       printf '%s' "Configuration" ;;
    start.config_provider)    printf '%s' "Provider" ;;
    start.config_model)       printf '%s' "Model" ;;
    start.config_language)    printf '%s' "Language" ;;
    start.config_cache)       printf '%s' "Compaction" ;;
    start.config_cache_on)    printf '%s' "enabled" ;;
    start.config_cache_off)   printf '%s' "disabled" ;;
    start.config_cache_tokens) printf '%s' "tokens reserved" ;;
    start.config_agents_off)  printf '%s' "Agents off" ;;
    start.config_mcp)         printf '%s' "MCP" ;;
    start.config_plugins)     printf '%s' "Plugins" ;;
